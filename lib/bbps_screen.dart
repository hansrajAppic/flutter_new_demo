// ignore_for_file: non_constant_identifier_names, prefer_const_constructors, camel_case_types, prefer_const_constructors_in_immutables, library_private_types_in_public_api, prefer_final_fields, unused_local_variable, unused_field, avoid_print, use_build_context_synchronously, duplicate_ignore, empty_statements
...
import 'package:demo/Json_model/bbpsoperator_model.dart';
import 'package:demo/Json_model/recwayrdfid_model.dart';
import 'package:demo/bill_pay_screen.dart';
   ...
   String? Mobile = await SharedPreferenceUtils.getValue("mob");
      ...
      if (Mobile != null) {
        ...
        final bbpsoperator = await MyGlobalFunctions.PostCall(
          '{"MethodName":"bbpsoperator","UserID":"$Mobile","Password":"$Password ", "ServiceName":"$ServiceName","AppType": " Apps"  }',
          "$deviceID",
        );
    ...
    try {
      ...
      if (Mobile != null) {
        ...
        final requiredfield = await MyGlobalFunctions.PostCall(
            '{"Number":"elebill","MethodName":"elebill","UserID":"$Mobile","Password":"$Password ", "OperatorID":"${jsonObject["OperatorID"].toString()}","AppType": "Apps","Optional1": "${jsonObject["Optional1"].toString()}", "Optional2": "${jsonObject["Optional2"].toString()}","Optional3": "${jsonObject["Optional3"].toString()}","Optional4": "${jsonObject["Optional4"].toString()}","Optional5": "${jsonObject["Optional5"].toString()}","Optional6": "${jsonObject["Optional6"].toString()}","Optional7": "${jsonObject["Optional7"].toString()}","Optional8": "${jsonObject["Optional8"].toString()}","Optional9": "${jsonObject["Optional9"].toString()}"}',
            "$deviceID");
    ...
    try {
     ...
     String? Mobile = await SharedPreferenceUtils.getValue("mob");
      ...
      if (Mobile != null) {
        ...
        final requiredfield = await MyGlobalFunctions.PostCall(
          '{"MethodName":"requiredfield","UserID":"$Mobile","Password":"$Password ", "spkey":"$id","AppType": " Apps"  }',
          "$deviceID",
        );
