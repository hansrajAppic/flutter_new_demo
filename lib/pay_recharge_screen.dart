// ignore_for_file: non_constant_identifier_names, duplicate_ignore, prefer_const_constructors, prefer_const_literals_to_create_immutables, use_build_context_synchronously, camel_case_types, empty_catches
...
import 'package:demo/recharge_share_receipt_Screen.dart';
   ...
   String? Mobile = await SharedPreferenceUtils.getValue("mob");
    ...
    if (Mobile != null && Password != null) {
      ...
      String? rechargerequest = await MyGlobalFunctions.PostCall(
        '{ "MethodName": "rechargerequest",  "UserID": "$Mobile",  "Password": "$Password",  "Number": "$mobilenumber",  "Amount": "$amount",  "Operator": "$opid",  "Circle": "$stateid",  "CANumber": "",  "Cycle": "",  "DueDate": "$mounted",  "Account": "",  "IPAddress": "$ipadders",  "IMEINumber": "",  "CustomerName": "",  "CustomerMobile": ""}',
        "$deviceID",
      );
