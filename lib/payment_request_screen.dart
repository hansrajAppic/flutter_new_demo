...
// ignore_for_file: prefer_final_fields, prefer_const_constructors, prefer_const_literals_to_create_immutables, avoid_print, use_build_context_synchronously, camel_case_types, non_constant_identifier_names
...
import 'package:demo/Json_model/getbanklist_model.dart';
   ...
   String? Mobile = await SharedPreferenceUtils.getValue("mob");
    ...
    if (Mobile != null) {
      ...
      String? getbanner = await MyGlobalFunctions.PostCall(
        '{"MethodName":"getbanklist","UserID":"$Mobile","Password":"$Password", "AppType": " Apps"  }',
        "$deviceID",
      );
