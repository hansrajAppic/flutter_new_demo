// ignore_for_file: prefer_final_fields, prefer_const_constructors, prefer_const_literals_to_create_immutables, non_constant_identifier_names, empty_catches, unused_field, duplicate_ignore, unused_local_variable, use_build_context_synchronously, use_key_in_widget_constructors, prefer_const_constructors_in_immutables, camel_case_types, unnecessary_brace_in_string_interps, unnecessary_string_interpolations, prefer_is_empty, unused_element

import 'dart:convert';

// import 'package:bype_techno_projects1/Globale_class/circularProgressIndicator_class.dart';
...
// import 'package:bype_techno_projects1/Json_model/getoprater_model.dart';
// import 'package:bype_techno_projects1/Json_model/getstate_model.dart';
// import 'package:bype_techno_projects1/Json_model/plannew.dart';
// import 'package:bype_techno_projects1/globale_class.dart';
// import 'package:bype_techno_projects1/pay_recharge_screen.dart';
// import 'package:bype_techno_projects1/splesh_screen.dart';
import 'package:demo/Globale_class/circularProgressIndicator_class.dart';
import 'package:demo/Globale_class/colors.dart';
import 'package:demo/Globale_class/shardPreferance.dart';
import 'package:demo/Json_model/getoprater_model.dart';
import 'package:demo/Json_model/getstate_model.dart';
import 'package:demo/Json_model/plannew.dart';
import 'package:demo/globale_class.dart';
import 'package:demo/pay_recharge_screen.dart';
                ...
                children: [
                  ListTile(
                    leading: Container(
                        ...
                        decoration: BoxDecoration(
                            border: Border.all(
                                color:
                                    const Color.fromARGB(255, 236, 210, 210)),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        ...
                        isCollapsed: true,
                        contentPadding:
                            const EdgeInsets.fromLTRB(13, 12, 0, 15),
...
// Tabbarvew
  ...
  Future<String?> PlannewapiCall(String op, String st) async {
    try {
      ...
      if (Mobile != null && Password != null) {
        ...
        if (data["success"].toString() == "true") {
          ...
          setState(() {
            flitterdataArray = operatorArray;
          });
          return plannew;
        } else {
  ...
  Future<void> apiCall() async {
    ...
    if (Mobile != null && Password != null) {
      ...
      String? getOperators = await MyGlobalFunctions.PostCall(
        '{"MethodName":"getoperators","UserID":"$Mobile","Password":"$Password","AppType": " Apps","ServiceTypeID":"1"}',
        "$deviceID",
      );
  ...
  Future<void> planvalidateApi(
    ...
    if (Mobile != null && Password != null) {
      ...
      String? getOperators = await MyGlobalFunctions.PostCall(
        '{"MethodName":"planvalidate", "OPID" :"$op", "CircleID":"$st", "Mobile": "$mo","Amount": "$amou", "UserID":"$Mobile","Password":"$Password","AppType": " Apps"}',
        "$deviceID",
      );
...
// // state
  ...
  Future<void> GetStateApi() async {
    try {
      ...
      if (Mobile != null && Password != null) {
        ...
        String? getOperators = await MyGlobalFunctions.PostCall(
          '{"MethodName":"getcircles","UserID":"$Mobile","Password":"$Password","AppType": " Apps","ServiceTypeID":"1"}',
          "$deviceID",
        );
  ...
  void _StateItemClick(BuildContext context, opDatagetstate selectedItem) {
    ...
    //PlannewapiCall(widget.SearchData["operatorID"].toString(),widget.SearchData["StateID"].toString());
  }
}
