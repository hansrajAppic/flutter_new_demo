...
// ignore_for_file: prefer_const_constructors, sort_child_properties_last, unused_field, non_constant_identifier_names, unnecessary_null_comparison, use_build_context_synchronously
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text(
          'Send Money',
          style: TextStyle(
              color:AppColors.whiteColor, fontSize: 16, fontWeight: FontWeight.w800),
        ),
        actions: [
          Icon(Icons.help_outline_outlined, color: AppColors.whiteColor, size: 22),
  ...
  String? Mobile = await SharedPreferenceUtils.getValue("mob");
      ...
      if (Mobile != null) {
        ...
        final sendamtupi = await MyGlobalFunctions.PostCall(
          '{"MethodName":"sendamtupi","UserID":"${Mobile}","Password":"${Password}", "upiid": "${upiController.text}" ,"Amount": "${amountController.text}","TPIN": "12345",}',
          "$deviceID",
        );
  ...
  String? Mobile = await SharedPreferenceUtils.getValue("mob");
      ...
      if (Mobile != null) {
        ...
        final upiverification = await MyGlobalFunctions.PostCall(
          '{"MethodName":"upiverification","UserID":"${Mobile}","Password":"${Password}", "upiid": "${upiController.text}" ,}',
          "$deviceID",
        );
