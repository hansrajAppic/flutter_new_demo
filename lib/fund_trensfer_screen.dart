// ignore_for_file: prefer_const_constructors, prefer_const_literals_to_create_immutables, sort_child_properties_last, unnecessary_brace_in_string_interps, non_constant_identifier_names, deprecated_member_use, unused_local_variable, use_build_context_synchronously, duplicate_ignore
...
import 'package:demo/Json_model/findmemberdetails_model.dart';
    ...
    try {
      ...
      if (Mobile != null) {
        ...
        final findmemberdetails = await MyGlobalFunctions.PostCall(
          '{"MethodName":"findmemberdetails","UserID":"${Mobile}","Password":"${Password}", "MobileNo": "${mobileController.text}" }',
          "$deviceID",
        );
    ...
    String? Mobile = await SharedPreferenceUtils.getValue("mob");
      ...
      if (Mobile != null) {
        ...
        final fundtransfer = await MyGlobalFunctions.PostCall(
          '{"MethodName":"fundtransfer","UserID":"${Mobile}","Password":"${Password}", "ToUserID":"${mobileController.text}", "Amount": "${amountController.text}"}',
          "$deviceID",
        );
